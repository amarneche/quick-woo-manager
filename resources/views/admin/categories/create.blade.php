    ...
    <div class="offcanvas-body  mx-0 flex-grow-0">
        <form action="{{ route('admin.categories.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="row-md-12">
                    <div class="mb-3">
                      <label for="featured" class="form-label">Main Image</label>
                      <input type="file" class="form-control" name="featured" id="featured" placeholder="" aria-describedby="featuredImageHelp">
